...
function Tooted() {
  ...
  const sorteeriKasvavalt = () => {
    const sorteeritudTooted = tooted.slice().sort((a, b) => a.length - b.length)
    setTooted(sorteeritudTooted)
  }
  
  const sorteeriKahanevalt = () => {
    const sorteeritudTooted = tooted.slice().sort((a, b) => b.length - a.length)
    setTooted(sorteeritudTooted)
  }
  
  const sorteeriTeineTahtAZ = () => {
    const sorteeritudTooted = tooted.slice().sort((a, b) => a[1].localeCompare(b[1]))
    setTooted(sorteeritudTooted)
  }
