...
function Hind() {
  ...
  return (
    <>
      ...
      <img onClick={() => setValitudTelefon(3210)} className={`telefon ${valitudTelefon == 3210 && "valitud-telefon"}`} src={nokia3210} alt="" />
      <img onClick={() => setValitudTelefon(3310)} className={`telefon ${valitudTelefon == 3310 && "valitud-telefon"}`} src={nokia3310} alt="" />
      <img onClick={() => setValitudTelefon(3410)} className={`telefon ${valitudTelefon == 3410 && "valitud-telefon"}`} src={nokia3410} alt="" />

      <br/>
      <button onClick={ () => setValitudRam(4) } className={valitudRam == 4 && "valitud-ram"}>4MB</button>
      <button onClick={ () => setValitudRam(8) } className={valitudRam == 8 && "valitud-ram"}>8MB</button>
      <button onClick={ () => setValitudRam(16) } className={valitudRam == 16 && "valitud-ram"}>16MB</button>
      <button onClick={ () => setValitudRam(32) } className={valitudRam == 32 && "valitud-ram"}>32MB</button>
      ...
      { valitudTelefon != "" && valitudRam != ""  &&
        <>
          <div>Nokia {valitudTelefon} + {valitudRam}MB RAM</div>
