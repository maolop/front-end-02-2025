...
function Ilmumine() {
	...
	function aktiveeriPakett(pakett) {
		...
		if (pakett === "home") setHomeAktiivne(!homeAktiivne);
		else if (pakett === "homePlus") setHomePlusAktiivne(!homePlusAktiivne);
		else if (pakett === "addict") setAddictAktiivne(!addictAktiivne);
		else if (pakett === "fanatic") setFanaticAktiivne(!fanaticAktiivne);
	}
	...
	return (
		<>
			...
			<button
				className={`pakett ${homePlusAktiivne ? "aktiivne-pakett" : ""}`}
				onClick={() => aktiveeriPakett("homePlus")}
			>
				Home+
			</button>
			<button
			...
			<button
				className={`pakett ${fanaticAktiivne ? "aktiivne-pakett" : ""}`}
				onClick={() => aktiveeriPakett("fanatic")}
			>
				Fanatic
			</button>
