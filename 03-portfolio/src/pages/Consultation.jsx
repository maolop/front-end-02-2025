  ...
  return (
    <>
        <ol className="projects">
            ...
            <li>Cybersecurity & Data Protection – Ensuring robust security measures and compliance with industry standards.</li>
            <li>Cloud Computing Solutions – Helping companies transition to and optimize cloud-based infrastructure.</li>
            <li>AI & Machine Learning Integration – Strategic implementation of AI-driven solutions for business growth.</li>
