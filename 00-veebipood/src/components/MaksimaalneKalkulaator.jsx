...
export default function MaksimaalneKalkulaator() {
  ...
  const uuendaMaxSumma = () => {
    setMaxSumma((sissetulekRef.current.value - kohustusedRef.current.value) * 1000 - ylalpeetavadRef.current.value * 10000)
  ...
  return (
    <>
      ...
      <input type="number" ref={sissetulekRef} onChange={uuendaMaxSumma} defaultValue="1500"/><br/>

      <label>Igakuised kohustused</label>
      <input type="number" ref={kohustusedRef} onChange={uuendaMaxSumma} defaultValue="600"/><br/>
